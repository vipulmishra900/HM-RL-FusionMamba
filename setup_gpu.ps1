# ==============================================================================
# PowerShell Setup Script - HM-RL-FusionMamba (GPU/CUDA Version)
# ==============================================================================

$ErrorActionPreference = "Stop"

Write-Host "======================================================================" -ForegroundColor Cyan
Write-Host "         Setting up HM-RL-FusionMamba GPU (CUDA) Environment" -ForegroundColor Cyan
Write-Host "======================================================================" -ForegroundColor Cyan
...
# 3. Modularly install PyTorch GPU version (CUDA 12.1)
# Note: For CUDA 11.8, replace 'cu121' with 'cu118'
Write-Host "`n[2/4] Installing modular PyTorch (CUDA 12.1 GPU build)..." -ForegroundColor Yellow
conda run -n hm-rl-fusionmamba pip install torch==2.1.2 torchvision==0.16.2 --extra-index-url https://download.pytorch.org/whl/cu121
